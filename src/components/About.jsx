  ...
  return (
    <section id="About" className="relative space-y-4 sm:space-y-6 ">
      ...
      <p className="text-justify indent-6 sm:px-4 md:px-8">
        Fourth-year BSIT student with a passion for front-end development.
        Committed to continuous learning and skill enhancement. Eager to apply
        my evolving expertise to create impactful user experiences in the
        professional world.
      </p>
